...
class Elite_Vaftire_Model_FlexibleSearchTests_FilterByTypeTest extends VF_TestCase
{
	function testFilterByType()
    {
        ...
        $flexibleSearch = $this->flexibleTireSearch(array('section_width'=>'205', 'aspect_ratio'=>'55', 'diameter'=>'16', 'tire_type'=>Elite_Vaftire_Model_Catalog_TireProduct::SUMMER_ALL));
	...
	function testOmitsDifferentType()
	{
        ...
        $flexibleSearch = $this->flexibleTireSearch(array('section_width'=>'205', 'aspect_ratio'=>'55', 'diameter'=>'16', 'tire_type'=>Elite_Vaftire_Model_Catalog_TireProduct::WINTER));
