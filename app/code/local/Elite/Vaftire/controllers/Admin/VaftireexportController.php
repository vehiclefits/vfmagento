 ...
 */
class Elite_Vaftire_Admin_VaftireexportController extends Mage_Adminhtml_Controller_Action
{
	...
	if (isset($_GET['go']))
	{
	    ...
	    $exporter = new VF_Tire_Catalog_TireProduct_Export($_FILES['file']['tmp_name']);
