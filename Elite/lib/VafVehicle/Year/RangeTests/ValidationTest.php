...
class VafVehicle_Year_RangeTests_ValidationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $range = new VafVehicle_Year_Range('02-03');
    ...
    {
        $range = new VafVehicle_Year_Range('-2005');
