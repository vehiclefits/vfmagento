<?php
class VafVehicle_Year_RangeTests_ValueTest extends PHPUnit_Framework_TestCase
{
    function testShouldDisableY2kModeForStartYear()
    {
        $range = new VafVehicle_Year_Range('24-56');
    ...
    {
        $range = new VafVehicle_Year_Range('2004-2005');
    ...
    {
        $range = new VafVehicle_Year_Range('04-05');
        $this->assertEquals( 2004, $range->start(), 'should get start year' );
    }
    ...
    {
        $range = new VafVehicle_Year_Range('20-40');
