<?php
class VafVehicle_YearTests_ValueTest extends PHPUnit_Framework_TestCase
{
    /**
    * @expectedException VafVehicle_Year_Exception
    */
    function testShouldThrowExceptionWhenParsingInvalid()
    {
        $year = new VafVehicle_Year('invalid');
        $year->value();
    }
    
    function testShouldDisableY2kMode()
    {
        $year = new VafVehicle_Year(24);
