...
php C:/wamp/bin/php/php5.3.0/phpunit --no-globals-backup  --stop-on-failure --verbose --bootstrap E:\dev\vaf\app\code\local\Elite\Vaf\bootstrap-tests.php E:\dev\vaf\app\code\local\Elite\%*